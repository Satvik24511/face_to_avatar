...
class ResidualBlock(nn.Module):
    def __init__(self, channels):
        ...
        self.block = nn.Sequential(
            ...
            ConvBlock(channels, channels, kernel_size=3, stride=1, padding=1, use_act=False)
        )
    ...
    def __init__(self, img_channels, num_features = 64,num_residuals=9):
        ...
        self.up_blocks = nn.ModuleList(
            [
                ...
                ConvBlock(num_features*2, num_features, kernel_size=3, stride=2, padding=1, output_padding=1, down=False)
            ]
        )
